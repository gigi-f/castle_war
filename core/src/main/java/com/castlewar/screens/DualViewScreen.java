...
public class DualViewScreen implements Screen {
    ...
    private final float[] isoPointBuffer = new float[2]; // Reusable buffer for isometric projection
    private final Color tempColor = new Color(); // Reusable color object to avoid allocations
    ...
    private static final Color OVERLAY_BUBBLE_COLOR = new Color(0.1f, 0.1f, 0.15f, 0.85f);
    private static final Color MODAL_BUBBLE_COLOR = new Color(0.1f, 0.1f, 0.15f, 0.9f);
    private static final Color FOG_COLOR = new Color(0.85f, 0.87f, 0.9f, 1f);
    private static final Color KING_DARK_CROWN_COLOR = new Color(0.4f, 0.4f, 0.4f, 1f);
    private static final Color ASSASSIN_WHITE_HOOD_COLOR = new Color(0.8f, 0.8f, 0.9f, 1f);
    private static final Color ASSASSIN_BLACK_HOOD_COLOR = new Color(0.2f, 0.1f, 0.1f, 1f);
